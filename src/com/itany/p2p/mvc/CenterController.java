...
public class CenterController extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		// 加载struts-*.xml规则
		Digester digester = DigesterLoader.createDigester(CenterController.class.getClassLoader()
		...
		try {
			...
			digester.parse(CenterController.class.getClassLoader().getResourceAsStream("struts.xml"));
			// 将对象存入list
...
System.out.println("nameSpace: "+nameSpace);
			...
			name = name.substring(name.lastIndexOf("/") + 1,name.lastIndexOf(".do"));
