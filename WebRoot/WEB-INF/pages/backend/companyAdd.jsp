...
<body style="padding: 5px 10px">
	...
	<div class="panel panel-primary">
	  ...
	  <div class="panel-body">
	  	...
	  	<form class="form-horizontal" role="form" action="companyAdd.do" method="post">
	  		
            <div class="form-group">
              <label for="companyName" class="col-lg-2 control-label">企业名称</label>
              <div class="col-lg-10">
                <input type="text" class="form-control" name="companyName" id="companyName" placeholder="产品名称">
              </div>
            </div>
            ...
            <div class="form-group">
            	...
            	<div class="col-lg-10">
			        <div class="input-group col-lg-3" style="float: left;">
			            <input type="text" class="form-control" name="commissionNum" placeholder="佣金数">
